  ...
  return (
    ...
    <div className="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
        <div className="mx-auto max-w-screen-sm text-center">
            ...
            <Link href="/" className="inline-flex text-white bg-primary-600 hover:bg-primary-800 focus:ring-4 px-3 py-2 rounded-md focus:outline-none focus:ring-primary-900 my-4">Back to Homepage</Link>
        </div>   
    </div>
</section>
  );
