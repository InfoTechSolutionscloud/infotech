...
const Hero = () => {
  return (
    <Template>
      <div
        id="herosection"
        className="flex flex-row items-center -mt-5 justify-center bg-[url('/bg.jpg')] bg-left min-h-screen w-full px-8 lg:px-20 text-left"
      >
        <motion.div
          initial={{ y: "10vh", opacity: 0 }}
          animate={{ y: 0, opacity: 1 }}
          transition={{ duration: 1 }}
          className="flex flex-col filter backdrop:blur-xl items-center justify-center w-1/2 xyz-in"
        >
          <h1
            className="text-5xl lg:text-7xl font-bold lato text-white xyz-nested xyz-in-up"
            initial={{ y: "100vh", opacity: 0 }}
            animate={{ y: 0, opacity: 1 }}
            transition={{ duration: 1 }}
          >
            Have an Idea? Make It Digital with{" "}
            <span className="text-secondary-400 xyz-in-down">Infotech</span>!
          </h1>
          <p
            className="mt-6 text-lg lg:text-xl font-medium raleway text-gray-200 xyz-nested xyz-in-up-delay-1"
            initial={{ y: "100vh", opacity: 0 }}
            animate={{ y: 0, opacity: 1 }}
            transition={{ duration: 1 }}
          >
        ...
        <motion.div
          ...
          animate={{ scale: 1, opacity: 1 }}
          transition={{ duration: 1 }}
          className="w-1/2 xyz-in xyz-in-right"
        >
          <Image
            src={"/techimage.jpg"}
            width={600}
