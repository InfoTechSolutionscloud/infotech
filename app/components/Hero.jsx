  ...
  return (
    <Template>
      ...
      >
        ...
        >
<h1
  className="text-5xl lg:text-7xl font-bold lato text-center md:text-left lg:pl-8 w-full text-transparent bg-clip-text bg-gradient-to-r from-teal-400 to-cyan-600 pb-5 pt-5"
