        ...
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
          <div>
            <Link href="/" className="flex items-center select-none">
              <Image src={"/logo.png"} width={200} height={200} className='w-28 ' />
            </Link>
            <p className="max-w-xs mt-4 text-sm text-gray-200">
              Make Your Business Digital!
            </p>
            <div className="flex mt-8 space-x-6 text-gray-200">
              <a className="hover:opacity-75" href="https://www.facebook.com/profile.php?id=61563953222407&mibextid=ZbWKwL" target="_blank" rel="noreferrer">
                <span className="sr-only"> Facebook </span>
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                  <path fillRule="evenodd" d="M22 12c0-5.523-4.477-10-10-10S2 6.477 2 12c0 4.991 3.657 9.128 8.438 9.878v-6.987h-2.54V12h2.54V9.797c0-2.506 1.492-3.89 3.777-3.89 1.094 0 2.238.195 2.238.195v2.46h-1.26c-1.243 0-1.63.771-1.63 1.562V12h2.773l-.443 2.89h-2.33v6.988C18.343 21.128 22 16.991 22 12z" clipRule="evenodd" />
                </svg>
              </a>
              <a className="hover:opacity-75" href="https://www.instagram.com/infotech.solutions.company?igsh=MW5sZWZodm44NnU1" target="_blank" rel="noreferrer">
              ...
              <a className="hover:opacity-75" href="https://www.linkedin.com/company/infotech-solutions-company/" target="_blank" rel="noreferrer">
                <span className="sr-only"> Linkedin </span>
                <Image src="/linkedin-logo.svg" width={24} height={24} className='filter invert' />
              </a>
            </div>
          </div>
          <div className="grid grid-cols-1 gap-8 lg:col-span-2 sm:grid-cols-2 lg:grid-cols-4">
            <div>
              ...
              <nav className="flex flex-col mt-4 space-y-2 text-sm text-gray-200">
                ...
                <Link className="hover:opacity-75" href="/track-project"> Track Project </Link>
                <Link className="hover:opacity-75" href="/get-service"> Request For Service </Link>
              </nav>
            </div>
            <div>
              <p className="font-medium text-white">
