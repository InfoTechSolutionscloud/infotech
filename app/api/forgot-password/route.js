...
//     const resetUrl = `http://localhost:3000/team/forgot-password/${resetToken}`
...
//     try {
//         await user.save();
//         return new Response(JSON.stringify({ message: "Email is sent for reseting the password" }), { status: 200 });
//     } catch(error) {
