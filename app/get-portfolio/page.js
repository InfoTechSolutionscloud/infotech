                ...
                <div className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8 lg:py-20">
                    ...
                    >
                        <div className="mb-6 max-w-3xl text-center sm:text-center md:mx-auto md:mb-12">
                            ...
                            >
                                Welcome to Infotech Portfolio
                            </h2>
                            <p className="mx-auto mt-4 max-w-3xl text-xl text-slate-400">
                                Find the best portfolio that accelerate your business.</p>
                        </div>
                    </motion.div>
                    {intro && (
                                    ...
                                    {step == 2 && (
                                        <div className="mb-6">
                                            <div className="mx-0 mb-1 sm:mb-4">
                                                ...
                                                <select id="portfolio" name="portfolio" className="mb-2 w-full rounded-md border border-secondary-400 py-2 pl-2 pr-4 shadow-md bg-gray-800 text-white sm:mb-0" value={formData.portfolio} onChange={onChangeForm} required>
